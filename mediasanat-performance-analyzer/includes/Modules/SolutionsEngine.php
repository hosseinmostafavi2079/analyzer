        ...
        if ( ! $speed_test_ok ) {
            ...
            if ( $external_count > 0 ) {
                $solutions[] = [
                    ...
                    'fix'   => 'در تب «وابستگی‌های خارجی» دامنه و نوع فایل را ببینید؛ فونت، اسکریپت، تصویر و استایل را روی هاست ایران میزبانی و آدرس آن را محلی کنید.'
                ];
            }
            // ===== تحلیل TTFB =====
            ...
            if ( $ttfb > 1.5 ) {
                $solutions[] = [
                    ...
                    'fix'   => 'کش صفحه و OPcache را فعال کنید، افزونه‌های سنگین را آزمایش کنید و در صورت تداوم مشکل منابع هاست را ارتقا دهید.'
                ];
            } elseif ( $ttfb > 0.8 ) {
                $solutions[] = [
                    'type'  => 'warning',
            ...
            if ( $assets_count > 50 ) {
                $solutions[] = [
                    ...
                    'fix'   => 'فایل‌های غیرضروری را حذف، CSS و JavaScript را کم‌حجم و بارگذاری اسکریپت‌های غیرحیاتی را به تعویق بیندازید.'
                ];
            }
        }
